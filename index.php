...
<body>
<ul class="nav d-flex justify-content-between text-light px-3" style="background-color: #c44dff">
        <li class="nav-item">
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-light">
    <div class="container-fluid">
      <img src="img/header.png" width=140 class="d-inline-block align-top" alt="">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="sub/precios.php">Precios</a>
          </li>
          <li class="nav-item">
